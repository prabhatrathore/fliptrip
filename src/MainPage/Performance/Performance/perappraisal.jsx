...
const PerformanceAppraisal = () => {
      ...
      render: (text, record) => (
        <div className="dropdown dropdown-action text-end">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_appraisal"><i className="fa fa-pencil m-r-5" /> Edit</a>
            <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_appraisal"><i className="fa fa-trash-o m-r-5" /> Delete</a>
          </div>
        </div>
      ),
    },
  ...
  return (
    <div className="page-wrapper">
      <Helmet>
        <title>Performance Appraisal - CRM created by Ebslon Infotech</title>
        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-end ml-auto">
              <a href="#" className="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_appraisal"><i className="fa fa-plus" /> Add New</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
                          ...
                          <div className="row user-tabs">
                            <div className="col-lg-12 col-md-12 col-sm-12 line-tabs">
                              <ul className="nav nav-tabs nav-tabs-solid">
                                <li className="nav-item"><a href="#appr_technical" data-bs-toggle="tab" className="nav-link active">Technical</a></li>
                                <li className="nav-item"><a href="#appr_organizational" data-bs-toggle="tab" className="nav-link">Organizational</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="card-body">
                        <div className="tab-box">
                          <div className="row user-tabs">
                            <div className="col-lg-12 col-md-12 col-sm-12 line-tabs">
                              <ul className="nav nav-tabs nav-tabs-solid">
                                <li className="nav-item"><a href="#appr_technical1" data-bs-toggle="tab" className="nav-link active">Technical</a></li>
                                <li className="nav-item"><a href="#appr_organizational1" data-bs-toggle="tab" className="nav-link">Organizational</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
