      ...
      render: (text, record) => (
        <div className="dropdown dropdown-action text-end">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_termination"><i className="fa fa-pencil m-r-5" /> Edit</a>
            <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_termination"><i className="fa fa-trash-o m-r-5" /> Delete</a>
          </div>
        </div>
      ),
    },
        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-end ml-auto">
              <a href="#" className="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_termination"><i className="fa fa-plus" /> Add Termination</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
