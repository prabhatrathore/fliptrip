...
const ThemeSettings = () => {
  ...
  return (
    <div className="page-wrapper">
      <Helmet>
        <title>Theme Settings - CRM created by Ebslon Infotech</title>
            ...
            <form>
              ...
              <div className="form-group row">
                ...
                <div className="col-lg-2">
                  <div className="img-thumbnail float-end"><img src={Applogo} alt="" width={40} height={40} /></div>
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-lg-2">
                  <div className="settings-image img-thumbnail float-end"><img src={Applogo} className="img-fluid" width={16} height={16} alt="" /></div>
                </div>
              </div>
